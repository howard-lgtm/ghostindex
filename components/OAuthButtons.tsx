...
export default function OAuthButtons() {
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        disabled={true}
        className="w-full flex items-center justify-center gap-3 px-4 py-3 border rounded-lg font-medium transition-colors opacity-50 cursor-not-allowed"
        style={{
          borderColor: 'var(--border)',
          background: 'var(--bg)',
          color: 'var(--text-dim)',
        }}
        title="LinkedIn OAuth coming soon - provider configuration in progress"
      >
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#0A66C2" opacity="0.5">
