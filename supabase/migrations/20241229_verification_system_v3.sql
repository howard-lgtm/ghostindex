-- Migration: Add verification-first architecture (Fixed version)
...
-- Remove the generated column and make it a regular column that gets updated by a function
ALTER TABLE reports ADD COLUMN IF NOT EXISTS days_since_contact INTEGER;
...
-- Create email_verifications table for Mailgun inbound parsing
...
-- Function to update days_since_contact
...
BEGIN
  ...
  PERFORM update_days_since_contact();
